    ...
    <main className="min-h-screen bg-slate-50 dark:bg-slate-950">
      ...
      <section className="bg-slate-50 dark:bg-slate-800 px-6 py-14 sm:py-20">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-wrap gap-3 mt-6">
            ...
            <Link href="/how-to" className="px-5 py-2.5 rounded-xl border border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-200 text-sm font-bold hover:bg-slate-100 dark:hover:bg-slate-800 dark:bg-slate-800 transition-colors">
              How to Use rawcv
            </Link>
          </div>
        </div>
      ...
      <div className="max-w-4xl mx-auto px-6 pb-20 -mt-4 space-y-12">
        ...
        <section>
          ...
          <p className="text-sm text-slate-500 dark:text-slate-300 mb-6">Follow this exact order for maximum compatibility with EU recruiters and ATS systems.</p>
        ...
        <section className="rounded-3xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 p-6 shadow-md">
          <h2 className="text-xl font-bold text-slate-900 dark:text-white mb-4">🗣️ CEFR Language Levels Explained</h2>
        ...
        {/* Tips */}
        <section className="rounded-3xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 p-6 shadow-md">
          <h2 className="text-xl font-bold text-slate-900 dark:text-white mb-4">💡 EU Resume Tips</h2>
