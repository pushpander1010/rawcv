  ...
  return (
    <div className="max-w-lg mx-auto">
      ...
      <div className="mt-4 flex gap-3 justify-center">
        ...
        <Link href="/chat" className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl border border-gray-200 dark:border-slate-700 text-sm font-medium bg-white dark:bg-slate-900 hover:bg-gray-50 hover:scale-[1.02] active:scale-[0.98] transition-all duration-200 shadow-sm">
          💬 Build from scratch
        </Link>
      </div>
    </div>
  ...
  return (
    <section className="py-20 px-6 text-center">
      ...
      <div className="flex gap-4 justify-center">
        ...
        <Link href="/chat" className="inline-flex items-center px-6 py-3 rounded-xl border border-gray-200 dark:border-slate-700 text-sm font-medium bg-white dark:bg-slate-900 hover:bg-gray-50 hover:scale-[1.02] active:scale-[0.98] transition-all duration-200 shadow-sm">💬 Build from scratch</Link>
      </div>
    </section>
  );
}
