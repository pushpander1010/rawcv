...
export default function UndoChatButton({ onUndoChat, disabled }: Props) {
  ...
  return (
    <button
      ...
      className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-slate-200 dark:border-slate-700 text-xs text-slate-500 dark:text-slate-300 hover:bg-blue-50 dark:hover:bg-blue-500/20 dark:bg-blue-950/30 hover:text-blue-600 hover:border-blue-200 transition-colors focus:outline-none focus:ring-2 focus:ring-blue-400 disabled:opacity-40 disabled:cursor-not-allowed"
    >
