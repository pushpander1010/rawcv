...
const SECTION_COLORS: Record<string, string> = {
  ...
  skills: "bg-amber-100 dark:bg-amber-900/40 text-amber-700 dark:text-amber-200",
  projects: "bg-teal-100 dark:bg-teal-900/40 text-teal-700 dark:text-teal-200",
  certifications: "bg-pink-100 dark:bg-pink-900/40 text-pink-700 dark:text-pink-200",
};
            ...
            <>
              ...
              {!editing && (
                <button
                  ...
                  className="text-xs font-semibold px-3 py-1.5 rounded-lg border border-blue-200 dark:border-blue-800 text-blue-600 hover:bg-blue-50 dark:hover:bg-blue-500/20 dark:bg-blue-950/30 transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500"
                >
                  Edit
                </button>
              )}
