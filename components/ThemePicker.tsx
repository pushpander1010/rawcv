    ...
    <div className="w-full">
      ...
      <div className="flex flex-col sm:flex-row gap-3 mb-5">
        <input
          ...
          className="flex-1 rounded-xl border border-gray-200 bg-white px-4 py-2.5 text-sm text-gray-800 placeholder-gray-500 focus:outline-none focus:border-brand-500 focus:ring-4 focus:ring-brand-500/10 transition-all duration-200 shadow-sm"
        />
      ...
      {/* Theme grid */}
      {filtered.length === 0 ? (
        <p className="text-sm text-gray-600 text-center py-8">No themes match your search.</p>
      ) : (
        <div
