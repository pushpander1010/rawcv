      ...
      <div className="flex items-center justify-between gap-3 px-4 py-3">
        ...
        <div className="flex items-center gap-2 shrink-0">
          ...
          <button
            ...
            className="p-1 rounded-lg text-slate-400 hover:text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 dark:bg-slate-800 transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500"
          >
            <svg
...
export default function SuggestionsList({ suggestions, loading = false }: SuggestionsListProps) {
  ...
  if (showLoader) {
    return (
      <section aria-label="AI Suggestions" className="rounded-2xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900">
