...
export default function FreeDownloadButton({ resume, theme, onValidationError }: Props) {
  ...
  return (
    <div className="space-y-3">
      ...
      <p className="text-xs text-gray-500 text-center">100% Free — No account required!</p>
      {showSuccessModal && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/60 backdrop-blur-sm p-4 animate-in fade-in duration-200">
          <div className="bg-white rounded-2xl p-6 max-w-md w-full shadow-2xl border border-gray-100 transform animate-in zoom-in-95 duration-200">
            <div className="text-center space-y-4">
              ...
              <h3 className="text-xl font-bold text-gray-900">Resume Generated!</h3>
              <p className="text-sm text-gray-500">Your ATS-safe PDF is ready. Want to optimize your bullet points and match your resume to specific job descriptions with AI?</p>
              <div className="flex flex-col gap-2 pt-2">
                ...
                <button type="button" onClick={() => setShowSuccessModal(false)} className="w-full py-2.5 px-4 rounded-xl border border-gray-200 text-gray-700 hover:bg-gray-50 font-semibold text-sm">Maybe Later</button>
              </div>
            </div>
          </div>
        </div>
