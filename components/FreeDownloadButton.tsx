    ...
    <div className="space-y-3">
      ...
      {showSuccessModal && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/60 backdrop-blur-sm p-4 animate-in fade-in duration-200">
          <div className="bg-white dark:bg-slate-900 rounded-2xl p-6 max-w-md w-full shadow-2xl border border-gray-100 transform animate-in zoom-in-95 duration-200">
            <div className="text-center space-y-4">
              ...
              <div className="flex flex-col gap-2 pt-2">
                ...
                <button type="button" onClick={() => setShowSuccessModal(false)} className="w-full py-2.5 px-4 rounded-xl border border-gray-200 dark:border-slate-700 text-gray-700 hover:bg-gray-50 dark:bg-slate-800 font-semibold text-sm">Maybe Later</button>
              </div>
            </div>
          </div>
        </div>
