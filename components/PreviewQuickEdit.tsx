...
export function QuickEditJumpBar() {
  function scrollToQuickEdit() {
    ...
    // Flash the panel so the user sees where they landed
    el.classList.remove("qe-flash");
    void el.offsetWidth; // restart the animation
    el.classList.add("qe-flash");
  }
  return (
    <div className="mb-3">
      <button
        ...
        className="qe-glow-btn relative inline-flex items-center gap-1.5 text-xs font-semibold px-3.5 py-1.5 rounded-full text-white bg-brand-600 hover:bg-brand-700 transition-colors focus:outline-none focus:ring-2 focus:ring-brand-500 focus:ring-offset-2"
      >
